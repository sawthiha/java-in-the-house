...
public class AccCreation extends javax.swing.JFrame {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        String userID;
        String[] detail={txtAcctype.getText(),txtCustname.getText(),txtDob.getText(),"male",txtAddress.getText(),txtPhone.getText(),txtEmail.getText(),txtAmount.getText(),txtPswd1.getText()};
        InfoObject io=new InfoObject("create",null,PasswordField.userID,detail);
        io=MiscTools.send(io);
        JOptionPane.showMessageDialog(null,"Successfully Created!\nUser ID : "+io.content);
        userID=io.content;
        io=new InfoObject("detail",userID,PasswordField.userID);
        io=MiscTools.send(io);
        DetailForm df=new DetailForm(io.detail);
        df.setVisible(true);
        txtAcctype.setText("");
        txtAddress.setText("");
        txtAmount.setText("");
